# Prompts — Semana 9 · Ítem 3: El WACC ponderado
Marco: WACC · Modigliani-Miller

Conceptos a cubrir:
- WACC = E/V·Ke + D/V·Kd·(1−t)
- Escudo fiscal de la deuda
- Kd efectivo de la deuda onerosa
- WACC como vara mínima del ROIC
- Cuándo el WACC falla (estructura cambiante → APV)

---
## PROMPT 1 — Caso práctico
```
Actuá como CFO y profesor de finanzas corporativas. Generá un caso práctico realista sobre: WACC = E/V·Ke + D/V·Kd·(1−t); Escudo fiscal de la deuda; Kd efectivo de la deuda onerosa; WACC como vara mínima del ROIC; Cuándo el WACC falla (estructura cambiante → APV).
...
```
Resolvé el caso paso a paso. Para cada indicador (WACC = E/V·Ke + D/V·Kd·(1−t), Escudo fiscal de la deuda, Kd efectivo de la deuda onerosa): definición, fórmula, cálculo con los números, e interpretación para decidir.
```
