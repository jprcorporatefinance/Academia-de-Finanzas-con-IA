# Guía de Prompt Engineering — Semana 1
## Leer los estados contables sin miedo
...
- Lectura del Balance, Estado de Resultados y Flujo de Efectivo
- Ecuación contable Activo = Pasivo + Patrimonio Neto
- Capital de trabajo
- Liquidez corriente y ácida
- Diferencia entre resultado y caja
...
```
Actuá como profesor de finanzas corporativas avanzadas y consultor de CFOs. Quiero que generes un CASO PRÁCTICO original y realista sobre los siguientes conceptos: Lectura del Balance, Estado de Resultados y Flujo de Efectivo; Ecuación contable Activo = Pasivo + Patrimonio Neto; Capital de trabajo; Liquidez corriente y ácida; Diferencia entre resultado y caja.
...
```
Perfecto. Ahora resolvé el caso paso a paso, mostrando todas las fórmulas y el razonamiento. Para cada indicador (Lectura del Balance, Estado de Resultados y Flujo de Efectivo, Ecuación contable Activo = Pasivo + Patrimonio Neto, Capital de trabajo, Liquidez corriente y ácida...):
