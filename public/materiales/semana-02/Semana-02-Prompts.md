# Guía de Prompt Engineering — Semana 2
## Contabilidad de presentación vs. información de gestión
...
- Activos ocultos e intangibles no contabilizados
- Incobrables y obsolescencia de inventario
- Patrimonio neto económico
...
```
Actuá como profesor de finanzas corporativas avanzadas y consultor de CFOs. Quiero que generes un CASO PRÁCTICO original y realista sobre los siguientes conceptos: Contabilidad de presentación vs. información de gestión; Valor contable vs. valor de mercado; Activos ocultos e intangibles no contabilizados; Incobrables y obsolescencia de inventario; Patrimonio neto económico.
...
```
Perfecto. Ahora resolvé el caso paso a paso, mostrando todas las fórmulas y el razonamiento. Para cada indicador (Contabilidad de presentación vs. información de gestión, Valor contable vs. valor de mercado, Activos ocultos e intangibles no contabilizados, Incobrables y obsolescencia de inventario...):
