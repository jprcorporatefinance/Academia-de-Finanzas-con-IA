# Guía de Prompt Engineering — Semana 3
## De la utilidad al valor operativo: NOPAT, Capital Invertido y ROIC
...
- Capital invertido
- ROIC
- Descomposición DuPont (margen × rotación × multiplicador)
- Por qué el margen solo no alcanza
...
```
Actuá como profesor de finanzas corporativas avanzadas y consultor de CFOs. Quiero que generes un CASO PRÁCTICO original y realista sobre los siguientes conceptos: NOPAT = EBIT × (1 − t); Capital invertido; ROIC; Descomposición DuPont (margen × rotación × multiplicador); Por qué el margen solo no alcanza.
...
```
Perfecto. Ahora resolvé el caso paso a paso, mostrando todas las fórmulas y el razonamiento. Para cada indicador (NOPAT = EBIT × (1 − t), Capital invertido, ROIC, Descomposición DuPont (margen × rotación × multiplicador)...):
