# Guía de Prompt Engineering — Semana 4
## EVA y el spread ROIC − WACC: ganar plata y destruir valor a la vez
...
- Spread de valor
- Diferencia entre ganancia contable y creación de valor
- Capital invertido
- Cómo se puede destruir valor con utilidad positiva
...
```
Actuá como profesor de finanzas corporativas avanzadas y consultor de CFOs. Quiero que generes un CASO PRÁCTICO original y realista sobre los siguientes conceptos: EVA = (ROIC − WACC) × Capital invertido; Spread de valor; Diferencia entre ganancia contable y creación de valor; Capital invertido; Cómo se puede destruir valor con utilidad positiva.
...
```
Perfecto. Ahora resolvé el caso paso a paso, mostrando todas las fórmulas y el razonamiento. Para cada indicador (EVA = (ROIC − WACC) × Capital invertido, Spread de valor, Diferencia entre ganancia contable y creación de valor, Capital invertido...):
