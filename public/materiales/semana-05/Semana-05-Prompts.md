# Guía de Prompt Engineering — Semana 5
...
- Económico (resultado) vs. financiero (caja)
- Liquidez corriente, ácida y de caja
- Cobertura de intereses
- Solvencia y deuda/patrimonio
- Punto de inflexión y caída exponencial
...
```
Actuá como profesor de finanzas corporativas avanzadas y consultor de CFOs. Quiero que generes un CASO PRÁCTICO original y realista sobre los siguientes conceptos: Económico (resultado) vs. financiero (caja); Liquidez corriente, ácida y de caja; Cobertura de intereses; Solvencia y deuda/patrimonio; Punto de inflexión y caída exponencial.
...
```
Perfecto. Ahora resolvé el caso paso a paso, mostrando todas las fórmulas y el razonamiento. Para cada indicador (Económico (resultado) vs. financiero (caja), Liquidez corriente, ácida y de caja, Cobertura de intereses, Solvencia y deuda/patrimonio...):
