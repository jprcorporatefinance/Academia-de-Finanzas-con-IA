# Guía de Prompt Engineering — Semana 8
## Bienes de uso y CAPEX: lo que dice el libro y lo que vale en serio
...
- CAPEX vs. bien de uso contable
- Amortización y valor neto contable
- Valor contable vs. valor de mercado de activos fijos
- Activos intangibles no contabilizados
- CAPEX > amortización como señal de crecimiento
...
```
Actuá como profesor de finanzas corporativas avanzadas y consultor de CFOs. Quiero que generes un CASO PRÁCTICO original y realista sobre los siguientes conceptos: CAPEX vs. bien de uso contable; Amortización y valor neto contable; Valor contable vs. valor de mercado de activos fijos; Activos intangibles no contabilizados; CAPEX > amortización como señal de crecimiento.
...
```
Perfecto. Ahora resolvé el caso paso a paso, mostrando todas las fórmulas y el razonamiento. Para cada indicador (CAPEX vs. bien de uso contable, Amortización y valor neto contable, Valor contable vs. valor de mercado de activos fijos, Activos intangibles no contabilizados...):
