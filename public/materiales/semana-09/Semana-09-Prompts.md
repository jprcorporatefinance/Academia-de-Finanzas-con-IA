# Guía de Prompt Engineering — Semana 9
## El costo del capital: WACC en mercados emergentes
...
- CAPM ajustado a mercados emergentes
- Riesgo país y prima por tamaño
- Beta apalancada (Hamada)
- Costo del equity (Ke)
...
```
Actuá como profesor de finanzas corporativas avanzadas y consultor de CFOs. Quiero que generes un CASO PRÁCTICO original y realista sobre los siguientes conceptos: CAPM ajustado a mercados emergentes; Riesgo país y prima por tamaño; Beta apalancada (Hamada); Costo del equity (Ke); WACC = E/V·Ke + D/V·Kd·(1−t).
...
```
Perfecto. Ahora resolvé el caso paso a paso, mostrando todas las fórmulas y el razonamiento. Para cada indicador (CAPM ajustado a mercados emergentes, Riesgo país y prima por tamaño, Beta apalancada (Hamada), Costo del equity (Ke)...):
