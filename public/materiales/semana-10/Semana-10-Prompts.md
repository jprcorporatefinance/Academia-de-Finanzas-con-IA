# Guía de Prompt Engineering — Semana 10
## Apalancamiento: la deuda como multiplicador de ganancias y de pérdidas
...
- ROE apalancado = ROIC + (ROIC − i(1−t))·D/E
- La deuda como multiplicador de ganancias y pérdidas
- Riesgo económico vs. financiero
- Nivel óptimo de deuda y cobertura de intereses
- Modigliani-Miller en la práctica
...
```
Actuá como profesor de finanzas corporativas avanzadas y consultor de CFOs. Quiero que generes un CASO PRÁCTICO original y realista sobre los siguientes conceptos: ROE apalancado = ROIC + (ROIC − i(1−t))·D/E; La deuda como multiplicador de ganancias y pérdidas; Riesgo económico vs. financiero; Nivel óptimo de deuda y cobertura de intereses; Modigliani-Miller en la práctica.
...
```
Perfecto. Ahora resolvé el caso paso a paso, mostrando todas las fórmulas y el razonamiento. Para cada indicador (ROE apalancado = ROIC + (ROIC − i(1−t))·D/E, La deuda como multiplicador de ganancias y pérdidas, Riesgo económico vs. financiero, Nivel óptimo de deuda y cobertura de intereses...):
