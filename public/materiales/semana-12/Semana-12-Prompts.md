# Guía de Prompt Engineering — Semana 12
## Valuación integral por DCF y plan de creación de valor
...
- Valuación por DCF
- Proyección de FCFF y descuento al WACC
- Valor terminal (perpetuidad de Gordon)
- Enterprise Value vs. Equity Value
- Sensibilidad del valor al WACC y al crecimiento
...
```
Actuá como profesor de finanzas corporativas avanzadas y consultor de CFOs. Quiero que generes un CASO PRÁCTICO original y realista sobre los siguientes conceptos: Valuación por DCF; Proyección de FCFF y descuento al WACC; Valor terminal (perpetuidad de Gordon); Enterprise Value vs. Equity Value; Sensibilidad del valor al WACC y al crecimiento.
...
```
Perfecto. Ahora resolvé el caso paso a paso, mostrando todas las fórmulas y el razonamiento. Para cada indicador (Valuación por DCF, Proyección de FCFF y descuento al WACC, Valor terminal (perpetuidad de Gordon), Enterprise Value vs. Equity Value...):
