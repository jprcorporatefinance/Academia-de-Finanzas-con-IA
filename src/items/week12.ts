    ...
    theory: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'En Andina, la deuda onerosa suma descubierto (540), cheques diferidos (430), préstamos de corto (620) y de largo plazo (980), contra una caja e inversiones líquidas de unos 240: una deuda neta de unos 2.330k que, al valor actual, se **comería casi todo el Enterprise Value**. El escenario por defecto del simulador toma una deuda neta de 1.500k —un plan de desapalancamiento parcial— para que el equity quede positivo pero tenso, y se vea cómo al mover el WACC el valor del accionista puede cruzar a terreno negativo. Es la materialización del diagnóstico de todo el programa: Andina luce rentable pero está atrapada por su estructura de pasivos caros.',
