...
// ----------------------------------------------------------------------------
// Persistencia simple en localStorage (demo). Estructurado para migrar a un
// backend (Supabase) cambiando solo esta capa.
// ----------------------------------------------------------------------------
...
interface StoreApi {
  ...
  logout: () => void
  register: (data: Omit<User, 'id' | 'role' | 'avatarColor' | 'createdAt'>) => boolean
...
export function StoreProvider({ children }: { children: ReactNode }) {
  ...
  const api: StoreApi = {
    ...
    register(data) {
      if (state.users.some((u) => u.email.toLowerCase() === data.email.toLowerCase())) return false
